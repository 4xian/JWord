...
export const POINTER_AUTO_SCROLL_EDGE_PX = 24
export const POINTER_AUTO_SCROLL_INTERVAL_MS = 16
export const POINTER_AUTO_SCROLL_MAX_STEP_PX = 24
export const CARET_BLINK_INTERVAL_MS = 530
export const DEFERRED_DOCUMENT_RENDER_DELAY_MS = 40
export const DEFERRED_DOCUMENT_RENDER_PAGE_THRESHOLD = 50
export const DEFERRED_TEXT_MIRROR_SYNC_DELAY_MS = 40
export const DEFERRED_TEXT_MIRROR_SYNC_PAGE_THRESHOLD = 50
