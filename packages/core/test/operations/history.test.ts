...
import { createHistoryManager, DEFAULT_HISTORY_ORIGIN } from '../../src/operations/history'
import { createSelectionRestoreSnapshot, createSelectionState } from '../../src/model/selection'
...
import type { TextPosition } from '../../src/operations/transaction'
