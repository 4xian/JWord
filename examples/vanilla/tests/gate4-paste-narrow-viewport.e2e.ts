...
test('Gate 4 narrow viewport keeps paged canvas scrollable without implicit readonly mode', async ({ page }) => {
...
/** 读取窄屏视口下的 DOM 与 projection 状态。 */
async function readNarrowViewportProbe(page: Page): Promise<NarrowViewportProbe> {
  return page.evaluate(() => {
