 ...
 * Specs：docs/superpowers/plans/2026-05-11-jword-canonical-implementation.md#step-637。
 */
...
const collabDemoUrl = 'http://127.0.0.1:4190'
...
const collabHarnessPath = '/src/browser-handshake-harness.ts'
...
async function runBrowserHandshake(
  ...
  return page.evaluate(async ({ harnessPath, serverUrl: nextServerUrl, features: nextFeatures }) => {
